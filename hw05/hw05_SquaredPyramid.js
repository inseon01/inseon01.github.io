...
- The cube is rotating about the x-axis with given constant speed ->삭제
- A camera is rotating around the origin through the circle of radius 5->3
- The height (y position) of the camera is +2.->0~10, Math.sin()
...
function render() {
    ...
    let camY = 5.0 * Math.sin(glMatrix.toRadian(cameraYSpeed * elapsedTime)); //-5 ~ +5

    mat4.lookAt(viewMatrix, 
        vec3.fromValues(camX, camY + 5.0, camZ), // camera position
