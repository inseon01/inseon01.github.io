export class regularOctahedron {
    constructor(gl, options = {}) {
        ...
        this.vertices = new Float32Array([
            ...
            0.0,  Math.sqrt(2)/2,  0.0,  -0.5,  0.0,  0.5,  0.5,  0.0,  0.5,
            ...
            0.0,  Math.sqrt(2)/2,  0.0,  0.5,  0.0, -0.5,  -0.5,  0.0, -0.5,
            // down-front face (v5,v2,v1)
            0.0, -1*Math.sqrt(2)/2, 0.0,  0.5, 0.0,  0.5, -0.5, 0.0, 0.5,
            // down-right face (v5,v3,v2)
            0.0, -1*Math.sqrt(2)/2, 0.0,  0.5, 0.0,  -0.5, 0.5, 0.0, 0.5,
            // down-left face  (v5,v1,v4)
            0.0, -1*Math.sqrt(2)/2, 0.0,  -0.5, 0.0,  0.5, -0.5, 0.0, -0.5,
            // down-back face  (v5,v4,v3)
            0.0, -1*Math.sqrt(2)/2, 0.0,  -0.5, 0.0,  -0.5, 0.5, 0.0, -0.5
        ]);
        ...
        this.sameVertices = new Uint16Array([
            ...
            1, 8, 14, 19,     // indices of the same vertices as v1
            2, 4, 13, 17,     // indices of the same vertices as v2
            5, 10, 16, 23,    // indices of the same vertices as v3
            7, 11, 20, 22,    // indices of the same vertices as v4
            12, 15, 18, 21// indices of the same vertices as v5
        ]);
